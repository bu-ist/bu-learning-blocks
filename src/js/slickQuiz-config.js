...
const quizJSON = {
	info: {
		...
		main:
			'<p>Think you\'re smart enough to be on Jeopardy? Find out with this super crazy knowledge quiz!</p>',
		results:
	...
	questions: [
		...
		},
		{
			...
			correct:
				'<p><span>Good Job!</span> You must be very observant!</p>',
			incorrect:
				'<p><span>ERRRR!</span> What planet Earth are <em>you</em> living on?!?</p>', // no comma here
		}, // no comma here
	],
};
